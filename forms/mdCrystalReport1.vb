...
Public Class mdCrystalReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.mdCrystalReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmdCrystalReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As mdCrystalReport1 = New mdCrystalReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
