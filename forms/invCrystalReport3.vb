...
Public Class invCrystalReport3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.invCrystalReport3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvCrystalReport3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invCrystalReport3 = New invCrystalReport3()
        rpt.Site = Me.Site
        Return rpt
    End Function
