...
Public Class docCrystalReport3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.docCrystalReport3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddocCrystalReport3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As docCrystalReport3 = New docCrystalReport3()
        rpt.Site = Me.Site
        Return rpt
    End Function
