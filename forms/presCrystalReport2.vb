...
Public Class presCrystalReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.presCrystalReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpresCrystalReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As presCrystalReport2 = New presCrystalReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
