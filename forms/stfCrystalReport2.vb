...
Public Class stfCrystalReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.stfCrystalReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedstfCrystalReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As stfCrystalReport2 = New stfCrystalReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
